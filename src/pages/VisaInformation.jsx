...
const VisaInformation = () => {
  ...
  <ul className="text-lg">
    <li>• Foreign nationals are granted Conference Visas on production of an invitation to a conference/seminar/workshop being organized in India. 
    For business meetings or board meetings, to discuss business matters of a particular company/organization, a foreigner may obtain Business Visa.</li>

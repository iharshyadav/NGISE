...
const PaperSubmission = () => {
  return (
    <div className='mx-7 sm:mx-4 lg:mx-40 overflow-x-hidden'>
      ...
      <a href="https://easychair.org/conferences/?conf=icaibe2024" className='text-blue-500 underline text-xs sm:text-lg my-12 '>https://easychair.org/conferences/?conf=icaibe2024</a>
      ...
      <p className='my-4 sm:text-3xl text-xl font-bold'>Conference Track</p>
      <ol type="1">
        ...
        <p className='my-4 text-xs sm:text-lg' >8. Soft Comtext-xs sm:text-lg</p>
        </ol>
    </div>
  )
}

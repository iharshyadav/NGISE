...
const Registration = () => {
  let registrationinfo=[{
    ...
    fee:"INR 6000",
  },{data:"Participants from Academics",fee:"INR 6000"},{data:"Research Scholars and students",fee:"INR 4000"},{data:"Foreign Participants",fee:"	USD 100"}  ]
  ...
  return (
    ...
    <div style={{marginTop:"34px"}} ><h1>Registration Fees</h1></div>

...
const Footer= ()=> {
  return (
    <div>
      <section className="relative h-56 overflow-hidden text-white bg-[#383e46] pt-14">
        <div className="container relative z-10 mx-auto px-4">
          <div className="-m-8 flex h-28 items-center gap-72 justify-center">
            <div className="w-auto p-8 flex items-center justify-center">
              <a href="https://www.akgec.ac.in/">
                <div className="inline-flex items-center">
                  <img
                    className="sm:w-[7.5vw] w-[12vw]"
                    src="https://www.akgec.ac.in/wp-content/themes/twentysixteen/img/AKGEC_1_0.png"
                    alt=""
                  />
                </div>
              </a>
              {/* <a href="https://www.akgec.ac.in/"><h1 className='uppercase ml-5 font-semibold text-xl text-gray-600  cursor-pointer'>AJAY kumar garg engineering college</h1></a> */}
            </div>
            <div>

...
const Footer= ()=> {
  return (
    <section className="relative sm:block hidden h-56 overflow-hidden  bg-[#f4f3f379] py-8">
        ...
        <div className="-m-8 flex flex-wrap h-28 items-center justify-between">
          ...
          <div className="w-auto p-8">
            <ul className="-m-5 flex flex-wrap items-center">
              ...
              <li className="p-5">
                <a className="font-medium text-gray-600 hover:text-gray-700" href="/about">
                  About
                </a>
              </li>
              <li className="p-5">
      ...
      <div className='absolute top-36 w-full flex items-center justify-center'>
         <h1 className='uppercase text-lg font-sans font-semibold'>Design & Developed By : </h1>
         <img className='w-[4vw] pb-2' src="https://itbt-website.vercel.app/Images/Screenshot_2023-11-29_202207-removebg-preview.png" alt="" />
         <h1 className='uppercase text-lg font-sans font-semibold'>Big data center of excellence</h1>
      </div>
    </section>
  )
}
